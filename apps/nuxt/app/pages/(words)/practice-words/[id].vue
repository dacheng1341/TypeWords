...
useEvents([
  ...
  [ShortcutKey.PlayExample1, () => { console.log('[DEBUG-Alt+1] PlayExample1 event received in practice-words!'); typingRef?.playSentence?.(0) }],
  [ShortcutKey.PlayExample2, () => typingRef?.playSentence?.(1)],
